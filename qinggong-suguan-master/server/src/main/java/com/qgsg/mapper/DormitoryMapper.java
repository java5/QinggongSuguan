...
public interface DormitoryMapper {
    ...
    /**
     * 新增学生删除学生时把该学生的宿舍人数进行修改
     * @param i
     * @param dormitoryNumber
     */
    @Update("update dormitory set actual_capacity= #{i} where dormitory_number=#{dormitoryNumber}")
    void updateNumberOfPeople(int i,String dormitoryNumber);
